  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-sm",
        warning: "border-transparent bg-accent text-accent-foreground hover:bg-accent-hover shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
